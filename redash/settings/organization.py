...
JWT_AUTH_ISSUER = os.environ.get("REDASH_JWT_AUTH_ISSUER", "https://authsystem.msisolutions.co.uk/realms/MWAN")
JWT_AUTH_PUBLIC_CERTS_URL = os.environ.get("REDASH_JWT_AUTH_PUBLIC_CERTS_URL", "https://authsystem.msisolutions.co.uk/realms/MWAN/protocol/openid-connect/certs")
JWT_AUTH_AUDIENCE = os.environ.get("REDASH_JWT_AUTH_AUDIENCE", "account")
...
IDP_LOGIN = parse_boolean(os.environ.get("IDP_LOGIN", "true"))
settings = {
    "beacon_consent": None,
